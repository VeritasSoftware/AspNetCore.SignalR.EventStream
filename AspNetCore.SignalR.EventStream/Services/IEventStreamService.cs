...
namespace AspNetCore.SignalR.EventStream.Services
{
    ...
    {
        Task SetSubscriptionProcessorAsync(SetSubscriptionProcessorModel model);
        ...
        IAsyncEnumerable<EventModel> SearchEventsAsync(SearchEventsModel searchEventsModel);
    }
}